...
class Function():
    """
    Discretized, one-dimensional functions with specified x, y values and type (e.g. what dataset the function belongs to)
    """
    ...
    def get_neighbor_list(self, all_functions):
        """
        Updates list of neighbor functions, ordered starting with functions of lowest distance to this function.
        """
        neighbor_dist_list = []
    ...
    def get_dist(self, function_dist_pair):
        """
        Returns distance from a function-distance pair. Used as key for sorting a list.
        """
    ...
    def approx_distance_L2(self, function1, function2):
        """
        Returns the approximated L2 distance between two 1d functions discretized on the same grid.
        """
    ...
    def get_nns_all_functions(self, functions):
        """
        For all given functions, find the neighbor list ordered by smallest distance.
        """
        for f in functions:
